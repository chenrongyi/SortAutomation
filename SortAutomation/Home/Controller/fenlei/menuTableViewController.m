...
//            model.roomImageUrl=[NSString stringWithFormat:@"room%d",j%5];
            model.roomImageUrl = [NSString stringWithFormat:@"yuyue_icon"];
    ...
    if (!_myCollectionView) {
        ...
        self.myCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(tableWidthSize+leftMargin,0, kScreenWidth-tableWidthSize-2*leftMargin, kScreenHeight) collectionViewLayout:layout];
